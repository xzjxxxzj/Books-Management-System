        ...
        <div class="row">
            <div class="col-lg-8 col-md-7">
                <div class="card">
                    ...
                    <div class="content">
                        <form action="{{url('admin/setPassword')}}" method="post">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>旧密码：</label>{{$errors->first('oldPassword')}}
                                        <input type="password" class="form-control border-input" name="oldPassword" placeholder="请输入旧密码" value="">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
