        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-7">
                    <div class="card">
                        <div class="header">
                            <h4 class="title">修改图书类别</h4>
                        </div>
                        <div class="content">
                            <form action="{{url('admin/book/updateBookType')}}" method="post">
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control border-input" name="status">
                                                <option value="0" {{$typeInfo['status'] == 0 ? 'selected' : ''}}>启用</option>
                                                <option value="1" {{$typeInfo['status'] == 1 ? 'selected' : ''}}>禁用</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
