...
class BookUpdateBookRequest extends Request
{
    /**
    ...
    public function messages()
    {
        return [
            ...
            'bookId.required' => '图书ID不能为空！',
            'bookId.integer' => '图书ID格式不正确！',
            'bookId.min' => '图书ID不能小于1！',
            'bookId.exists' => '图书ID不存在！',
